...
@section('sidebar-nav')
    ...
    <a href="{{ route('cajero.shift.waiting') }}" class="nav-item active">
        <span class="nav-icon">⏳</span> Esperando Turno
    </a>
@endsection
...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; text-align: center;">
    ...
    <div class="card" style="max-width: 480px; width: 100%;">
        ...
        <div style="background: rgba(42,53,72,.4); border-radius: 8px; padding: 1rem; margin-bottom: 1.5rem;">
        ...
        <div style="border-top: 1px solid rgba(42,53,72,.5); padding-top: 1rem;">
